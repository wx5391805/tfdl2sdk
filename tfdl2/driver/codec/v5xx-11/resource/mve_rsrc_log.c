...
struct mve_rsrc_log_group mve_rsrc_log11;
struct mve_rsrc_log_group mve_rsrc_log_scheduler11;
struct mve_rsrc_log_group mve_rsrc_log_fwif11;
struct mve_rsrc_log_group mve_rsrc_log_session11;

EXPORT_SYMBOL(mve_rsrc_log11);
EXPORT_SYMBOL(mve_rsrc_log_fwif11);
EXPORT_SYMBOL(mve_rsrc_log_session11);
...
static void mve_rsrc_log_construct(struct mve_rsrc_log *log)
{
    ...
    log->mve_dir = debugfs_create_dir("mve11", NULL);
...
void mve_rsrc_log_init11(void)
{
    ...
    mve_rsrc_log_group_construct(&mve_rsrc_log11, "MVE", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "generic", &mve_rsrc_log11);

    mve_rsrc_log_group_construct(&mve_rsrc_log_scheduler11, "MVE scheduler", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "scheduler", &mve_rsrc_log_scheduler11);

    mve_rsrc_log_group_construct(&mve_rsrc_log_fwif11, "MVE fwif", MVE_LOG_INFO, drain_ram);
    mve_rsrc_log_group_add(&log, "firmware_interface", &mve_rsrc_log_fwif11);

    mve_rsrc_log_group_construct(&mve_rsrc_log_session11, "MVE session", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "session", &mve_rsrc_log_session11);
}

void mve_rsrc_log_destroy11(void)
{
    /* Destroy objects in reverse order. */
    mve_rsrc_log_destruct(&log);

    mve_rsrc_log_group_destruct(&mve_rsrc_log11);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_scheduler11);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_fwif11);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_session11);
...
const char *mve_rsrc_log_strrchr11(const char *s)
{
...
struct dentry *mve_rsrc_log_get_parent_dir11(void)
{
    return log.mve_dir;
}

EXPORT_SYMBOL(mve_rsrc_log_strrchr11);
EXPORT_SYMBOL(mve_rsrc_log_get_parent_dir11);
