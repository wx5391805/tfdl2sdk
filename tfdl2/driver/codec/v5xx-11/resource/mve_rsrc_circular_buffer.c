...
struct mver_circular_buffer *mver_circular_buffer_create11(int size)
{
...
void mver_circular_buffer_destroy11(struct mver_circular_buffer *cb)
{
    if (NULL != cb)
    {
...
static bool has_free_element(struct mver_circular_buffer *cb)
{
    ...
    return mver_circular_buffer_get_num_entries11(cb) < cb->size - 1;
}

bool mver_circular_buffer_add11(struct mver_circular_buffer *cb, void *item)
{
    bool ret = false;
...
bool mver_circular_buffer_remove11(struct mver_circular_buffer *cb, void **data)
{
    bool ret = false;

    if (mver_circular_buffer_get_num_entries11(cb) > 0)
    {
...
int mver_circular_buffer_get_num_entries11(struct mver_circular_buffer *cb)
{
    int num = 0;
...
bool mver_circular_buffer_peek11(struct mver_circular_buffer *cb, void **data)
{
    bool ret = false;
...
void mver_circular_buffer_remove_all_occurences11(struct mver_circular_buffer *cb, void *data)
{
    int curr;
