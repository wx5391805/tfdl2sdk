...
static uint32_t hw_version(void)
{
    ...
    if (0 == version)
    {
        version = mver_reg_get_version11();
    }
    return version;
}
...
static const struct mve_mem_virt_region *get_mem_virt_regions(void)
{
    ...
    {
        return mve_com_hi_v3_get_mem_virt_region11();
    }
    else
    {
        return mve_com_hi_v2_get_mem_virt_region11();
    }

    return NULL;
}

void mve_mem_virt_region_get11(enum mve_mem_virt_region_type type,
...
enum mve_mem_virt_region_type mve_mem_virt_region_type_get11(mve_addr_t mve_addr)
{
