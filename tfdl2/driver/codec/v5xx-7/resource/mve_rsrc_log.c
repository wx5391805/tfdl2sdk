...
struct mve_rsrc_log_group mve_rsrc_log7;
struct mve_rsrc_log_group mve_rsrc_log_scheduler7;
struct mve_rsrc_log_group mve_rsrc_log_fwif7;
struct mve_rsrc_log_group mve_rsrc_log_session7;

EXPORT_SYMBOL(mve_rsrc_log7);
EXPORT_SYMBOL(mve_rsrc_log_fwif7);
EXPORT_SYMBOL(mve_rsrc_log_session7);
...
static void mve_rsrc_log_construct(struct mve_rsrc_log *log)
{
    ...
    log->mve_dir = debugfs_create_dir("mve7", NULL);
...
void mve_rsrc_log_init7(void)
{
    ...
    mve_rsrc_log_group_construct(&mve_rsrc_log7, "MVE", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "generic", &mve_rsrc_log7);

    mve_rsrc_log_group_construct(&mve_rsrc_log_scheduler7, "MVE scheduler", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "scheduler", &mve_rsrc_log_scheduler7);

    mve_rsrc_log_group_construct(&mve_rsrc_log_fwif7, "MVE fwif", MVE_LOG_INFO, drain_ram);
    mve_rsrc_log_group_add(&log, "firmware_interface", &mve_rsrc_log_fwif7);

    mve_rsrc_log_group_construct(&mve_rsrc_log_session7, "MVE session", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "session", &mve_rsrc_log_session7);
}

void mve_rsrc_log_destroy7(void)
{
    /* Destroy objects in reverse order. */
    mve_rsrc_log_destruct(&log);

    mve_rsrc_log_group_destruct(&mve_rsrc_log7);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_scheduler7);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_fwif7);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_session7);
...
const char *mve_rsrc_log_strrchr7(const char *s)
{
...
struct dentry *mve_rsrc_log_get_parent_dir7(void)
{
    return log.mve_dir;
}

EXPORT_SYMBOL(mve_rsrc_log_strrchr7);
EXPORT_SYMBOL(mve_rsrc_log_get_parent_dir7);
