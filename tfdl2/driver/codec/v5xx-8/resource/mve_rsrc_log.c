...
struct mve_rsrc_log_group mve_rsrc_log8;
struct mve_rsrc_log_group mve_rsrc_log_scheduler8;
struct mve_rsrc_log_group mve_rsrc_log_fwif8;
struct mve_rsrc_log_group mve_rsrc_log_session8;

EXPORT_SYMBOL(mve_rsrc_log8);
EXPORT_SYMBOL(mve_rsrc_log_fwif8);
EXPORT_SYMBOL(mve_rsrc_log_session8);
...
static void mve_rsrc_log_construct(struct mve_rsrc_log *log)
{
    ...
    log->mve_dir = debugfs_create_dir("mve8", NULL);
...
void mve_rsrc_log_init8(void)
{
    ...
    mve_rsrc_log_group_construct(&mve_rsrc_log8, "MVE", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "generic", &mve_rsrc_log8);

    mve_rsrc_log_group_construct(&mve_rsrc_log_scheduler8, "MVE scheduler", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "scheduler", &mve_rsrc_log_scheduler8);

    mve_rsrc_log_group_construct(&mve_rsrc_log_fwif8, "MVE fwif", MVE_LOG_INFO, drain_ram);
    mve_rsrc_log_group_add(&log, "firmware_interface", &mve_rsrc_log_fwif8);

    mve_rsrc_log_group_construct(&mve_rsrc_log_session8, "MVE session", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "session", &mve_rsrc_log_session8);
}

void mve_rsrc_log_destroy8(void)
{
    /* Destroy objects in reverse order. */
    mve_rsrc_log_destruct(&log);

    mve_rsrc_log_group_destruct(&mve_rsrc_log8);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_scheduler8);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_fwif8);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_session8);
...
const char *mve_rsrc_log_strrchr8(const char *s)
{
...
struct dentry *mve_rsrc_log_get_parent_dir8(void)
{
    return log.mve_dir;
}

EXPORT_SYMBOL(mve_rsrc_log_strrchr8);
EXPORT_SYMBOL(mve_rsrc_log_get_parent_dir8);
