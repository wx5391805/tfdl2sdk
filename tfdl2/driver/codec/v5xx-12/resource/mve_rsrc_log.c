...
struct mve_rsrc_log_group mve_rsrc_log12;
struct mve_rsrc_log_group mve_rsrc_log_scheduler12;
struct mve_rsrc_log_group mve_rsrc_log_fwif12;
struct mve_rsrc_log_group mve_rsrc_log_session12;

EXPORT_SYMBOL(mve_rsrc_log12);
EXPORT_SYMBOL(mve_rsrc_log_fwif12);
EXPORT_SYMBOL(mve_rsrc_log_session12);
...
static void mve_rsrc_log_construct(struct mve_rsrc_log *log)
{
    ...
    log->mve_dir = debugfs_create_dir("mve12", NULL);
...
void mve_rsrc_log_init12(void)
{
    ...
    mve_rsrc_log_group_construct(&mve_rsrc_log12, "MVE", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "generic", &mve_rsrc_log12);

    mve_rsrc_log_group_construct(&mve_rsrc_log_scheduler12, "MVE scheduler", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "scheduler", &mve_rsrc_log_scheduler12);

    mve_rsrc_log_group_construct(&mve_rsrc_log_fwif12, "MVE fwif", MVE_LOG_INFO, drain_ram);
    mve_rsrc_log_group_add(&log, "firmware_interface", &mve_rsrc_log_fwif12);

    mve_rsrc_log_group_construct(&mve_rsrc_log_session12, "MVE session", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "session", &mve_rsrc_log_session12);
}

void mve_rsrc_log_destroy12(void)
{
    /* Destroy objects in reverse order. */
    mve_rsrc_log_destruct(&log);

    mve_rsrc_log_group_destruct(&mve_rsrc_log12);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_scheduler12);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_fwif12);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_session12);
...
const char *mve_rsrc_log_strrchr12(const char *s)
{
...
struct dentry *mve_rsrc_log_get_parent_dir12(void)
{
    return log.mve_dir;
}

EXPORT_SYMBOL(mve_rsrc_log_strrchr12);
EXPORT_SYMBOL(mve_rsrc_log_get_parent_dir12);
