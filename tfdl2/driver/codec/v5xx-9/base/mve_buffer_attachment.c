...
struct mve_buffer_external *mve_buffer_attachment_create_buffer_external9(struct mve_buffer_info *info)
{
...
void mve_buffer_attachment_destroy_buffer_external9(struct mve_buffer_external *buffer)
{
    MVE_RSRC_MEM_CACHE_FREE(buffer, sizeof(struct mve_buffer_external));
}

bool mve_buffer_attachment_map_physical_pages9(struct mve_buffer_external *buffer)
{
    CSTD_UNUSED(buffer);
...
bool mve_buffer_attachment_unmap_physical_pages9(struct mve_buffer_external *buffer)
{
    CSTD_UNUSED(buffer);
...
void mve_buffer_attachment_set_owner9(struct mve_buffer_external *buffer,
