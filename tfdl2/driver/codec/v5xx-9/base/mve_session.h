 ...
 */
mve_base_error mve_session_enqueue_flush_buffers9(struct mve_session *session,
                                                 uint32_t flush);
 ...
 * @return MVE error code.
 */
mve_base_error mve_session_enqueue_state_change9(struct mve_session *session,
...
void *mve_session_get_static_fptr9(char *func_name);
