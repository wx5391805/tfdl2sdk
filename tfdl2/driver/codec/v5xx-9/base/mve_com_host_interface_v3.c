...
struct mve_com *mve_com_host_interface_v3_new9(void)
{
    struct mve_com *com = mve_com_host_interface_v2_new9();
    if (NULL != com)
    {
...
const struct mve_mem_virt_region *mve_com_hi_v3_get_mem_virt_region9(void)
{
    return mem_regions;
}
