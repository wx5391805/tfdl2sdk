...
struct mve_rsrc_log_group mve_rsrc_log9;
struct mve_rsrc_log_group mve_rsrc_log_scheduler9;
struct mve_rsrc_log_group mve_rsrc_log_fwif9;
struct mve_rsrc_log_group mve_rsrc_log_session9;

EXPORT_SYMBOL(mve_rsrc_log9);
EXPORT_SYMBOL(mve_rsrc_log_fwif9);
EXPORT_SYMBOL(mve_rsrc_log_session9);
...
static void mve_rsrc_log_construct(struct mve_rsrc_log *log)
{
    ...
    log->mve_dir = debugfs_create_dir("mve9", NULL);
...
void mve_rsrc_log_init9(void)
{
    ...
    mve_rsrc_log_group_construct(&mve_rsrc_log9, "MVE", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "generic", &mve_rsrc_log9);

    mve_rsrc_log_group_construct(&mve_rsrc_log_scheduler9, "MVE scheduler", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "scheduler", &mve_rsrc_log_scheduler9);

    mve_rsrc_log_group_construct(&mve_rsrc_log_fwif9, "MVE fwif", MVE_LOG_INFO, drain_ram);
    mve_rsrc_log_group_add(&log, "firmware_interface", &mve_rsrc_log_fwif9);

    mve_rsrc_log_group_construct(&mve_rsrc_log_session9, "MVE session", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "session", &mve_rsrc_log_session9);
}

void mve_rsrc_log_destroy9(void)
{
    /* Destroy objects in reverse order. */
    mve_rsrc_log_destruct(&log);

    mve_rsrc_log_group_destruct(&mve_rsrc_log9);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_scheduler9);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_fwif9);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_session9);
...
const char *mve_rsrc_log_strrchr9(const char *s)
{
...
struct dentry *mve_rsrc_log_get_parent_dir9(void)
{
    return log.mve_dir;
}

EXPORT_SYMBOL(mve_rsrc_log_strrchr9);
EXPORT_SYMBOL(mve_rsrc_log_get_parent_dir9);
