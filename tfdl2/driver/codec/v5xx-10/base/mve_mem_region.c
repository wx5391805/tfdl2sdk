...
static uint32_t hw_version(void)
{
    ...
    if (0 == version)
    {
        version = mver_reg_get_version10();
    }
    return version;
}
...
static const struct mve_mem_virt_region *get_mem_virt_regions(void)
{
    ...
    {
        return mve_com_hi_v3_get_mem_virt_region10();
    }
    else
    {
        return mve_com_hi_v2_get_mem_virt_region10();
    }

    return NULL;
}

void mve_mem_virt_region_get10(enum mve_mem_virt_region_type type,
...
enum mve_mem_virt_region_type mve_mem_virt_region_type_get10(mve_addr_t mve_addr)
{
