 ...
 */
mve_base_error mve_session_enqueue_flush_buffers10(struct mve_session *session,
                                                 uint32_t flush);
 ...
 * @return MVE error code.
 */
mve_base_error mve_session_enqueue_state_change10(struct mve_session *session,
...
void *mve_session_get_static_fptr10(char *func_name);
