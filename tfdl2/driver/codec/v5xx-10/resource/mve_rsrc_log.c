...
struct mve_rsrc_log_group mve_rsrc_log10;
struct mve_rsrc_log_group mve_rsrc_log_scheduler10;
struct mve_rsrc_log_group mve_rsrc_log_fwif10;
struct mve_rsrc_log_group mve_rsrc_log_session10;

EXPORT_SYMBOL(mve_rsrc_log10);
EXPORT_SYMBOL(mve_rsrc_log_fwif10);
EXPORT_SYMBOL(mve_rsrc_log_session10);
...
static void mve_rsrc_log_construct(struct mve_rsrc_log *log)
{
    ...
    log->mve_dir = debugfs_create_dir("mve10", NULL);
...
void mve_rsrc_log_init10(void)
{
    ...
    mve_rsrc_log_group_construct(&mve_rsrc_log10, "MVE", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "generic", &mve_rsrc_log10);

    mve_rsrc_log_group_construct(&mve_rsrc_log_scheduler10, "MVE scheduler", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "scheduler", &mve_rsrc_log_scheduler10);

    mve_rsrc_log_group_construct(&mve_rsrc_log_fwif10, "MVE fwif", MVE_LOG_INFO, drain_ram);
    mve_rsrc_log_group_add(&log, "firmware_interface", &mve_rsrc_log_fwif10);

    mve_rsrc_log_group_construct(&mve_rsrc_log_session10, "MVE session", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "session", &mve_rsrc_log_session10);
}

void mve_rsrc_log_destroy10(void)
{
    /* Destroy objects in reverse order. */
    mve_rsrc_log_destruct(&log);

    mve_rsrc_log_group_destruct(&mve_rsrc_log10);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_scheduler10);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_fwif10);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_session10);
...
const char *mve_rsrc_log_strrchr10(const char *s)
{
...
struct dentry *mve_rsrc_log_get_parent_dir10(void)
{
    return log.mve_dir;
}

EXPORT_SYMBOL(mve_rsrc_log_strrchr10);
EXPORT_SYMBOL(mve_rsrc_log_get_parent_dir10);
